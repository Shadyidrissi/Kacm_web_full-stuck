...
function page() {
  return (
    <div className="about-page">
      ...
      <div id="cup-kacm">
        <img
          src="https://tmssl.akamaized.net/images/erfolge/verybigquad/363.png?lm=1461847499"
          alt=""
        />
        <img
          src="https://www.cafonline.com/media/0qgbnpk2/caf-confederation-cup-trophy.jpg"
          alt=""
        />
        <img
          src="https://upload.wikimedia.org/wikipedia/commons/3/38/Logo_Coupe_du_Maroc_de_football.png"
          alt=""
        />
      </div>
      <hr />
      <h1 className="title2">Kacm History</h1>
      <p>
